...
@section('content')
    ...
    {!! Form::model($campaign, ['method' => 'PUT', 'route' => ['admin.campaigns.update', $campaign->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('ads[]', $ads, old('ads') ? old('ads') : $campaign->ads->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-ads' ]) !!}
                    <p class="help-block"></p>
                    @if($errors->has('ads'))
                        <p class="help-block">
                            {{ $errors->first('ads') }}
