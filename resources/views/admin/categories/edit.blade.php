        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('advertiser_id[]', $advertiser_ids, old('advertiser_id') ? old('advertiser_id') : $category->advertiser_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-advertiser_id' ]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('ad_id[]', $ad_ids, old('ad_id') ? old('ad_id') : $category->ad_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-ad_id' ]) !!}
                    <p class="help-block"></p>
                    @if($errors->has('ad_id'))
                        <p class="help-block">
                            {{ $errors->first('ad_id') }}
