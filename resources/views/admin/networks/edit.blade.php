        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('affiliates[]', $affiliates, old('affiliates') ? old('affiliates') : $network->affiliates->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-affiliates' ]) !!}
                    <p class="help-block"></p>
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="stations">
                    ...
                    @empty
                        @foreach($network->stations as $item)
                            @include('admin.networks.stations_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
